...
plot(main="throughput time ordered by START_DATETIME",case_id_aggregated_information$START_DATETIME, case_id_aggregated_information$THROUGHPUT_TIME_HOURS, type = 'h')

```
```{r }
 ggplot(case_id_aggregated_information, aes(x = START_DATETIME, y = THROUGHPUT_TIME_HOURS)) + 
  geom_line() +
  labs(title = "Throughput time (in hrs) per case sorted by start datetime",
