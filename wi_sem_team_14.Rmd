...
"Happy Path" with the shortest throughput time:
processes should be oriented to it
![Happy Path](https://github.com/CTM-development/WI_Seminar/blob/main/Happy%20Path.jpg?raw=true)
