...
# load packages
pacman::p_load(pacman, tidyverse, rio, dplyr, ggplot2, plotly, tidyr, rmarkdown, tinytex, lubridate, gridExtra, scales, bupaR, daqapo)
...
```{r load dataset instead of building it}
...
#### plottin average throughput time per month
...
ggplot(tp_time_monthly_avg, aes(x = START_DT_MONTH)) + 
  ...
  labs(title = "Throughput time (in hrs) per case sorted by start date - red=median, blue=mean")
